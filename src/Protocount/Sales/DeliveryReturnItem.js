...
function DeliveryReturnItem (props) {
    ...
    function onChangeDeliveryReturnlineInput(e,order,lineNumber,innerOrder) {
    ...
    function deliveryreturnlineListRender(disabled) {
    return(
        inputState[linePosition].map((deliveryreturnlineSet,i)=>
        <div className='row flex-nowrap' style={{marginLeft:0,marginRight:0}} key={i}>
            ...
            <div className='col input-group' style={{flex:'1 0 50px',paddingLeft:0,paddingRight:0}}>
                ...
                onChange={(e)=>onChangeDeliveryReturnlineInput(e.target.value,linePosition,i,1)}/>
            ...
            onChange={(e)=>onChangeDeliveryReturnlineInput(e.target.value,linePosition,i,2)} disabled={disabled}
            ...
            onChange={(e)=>onChangeDeliveryReturnlineInput(e.target.value,linePosition,i,3)} disabled={disabled}
                            ...
                            <fieldset className='form-group col-md-12 mx-3 border border-secondary pb-4 rounded'>
                                <legend className='col-form-label col-10 offset-1 col-md-4 offset-md-4 text-center' >
                                    ...
                                    onClick={()=>
                                        ...
                                        +</button>
                                    <h6 className='d-inline-block mx-2 mx-md-4'>Delivery Return Line</h6>
                                ...
                                <div className="overflow-auto">
                                    ...
                                    {deliveryreturnlineListRender(disabled)}
